...
class ToDictParams(DataClass):
    ...
    def __str__(self) -> str:
        return f"ToDictParams(use_model_dump={self.use_model_dump}, fuzzy_parse={self.fuzzy_parse}, suppress={self.suppress}, str_type={self.str_type}, parser={self.parser}, recursive={self.recursive}, max_recursive_depth={self.max_recursive_depth}, recursive_python_only={self.recursive_python_only}, use_enum_values={self.use_enum_values})"

    def __repr__(self) -> str:
        return str(self)

    def __call__(self, input_, /):
        return to_dict(input_, **self.to_dict())
