...
def api_error(response_json: Mapping[str, Any]) -> bool:
    """
    Check if the given response_json dictionary contains an "error" key.
...
def api_rate_limit_error(response_json: Mapping[str, Any]) -> bool:
    """
    Check if the error message in the response_json dictionary contains the phrase "Rate limit".
