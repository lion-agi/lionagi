...
from lionagi.core.typing import Field, Note
...
class TestNodeTypes:
    ...
    def test_node_type_fields(self, mixed_type_graph):
        ...
        node_a1 = nodes["node_a1"]
        node_a1.value = 30
        assert graph.internal_nodes[node_a1.ln_id].value == 30

        # Test TypeB specific field
        node_b1 = nodes["node_b1"]
        node_b1.name = "NewB1"
        assert graph.internal_nodes[node_b1.ln_id].name == "NewB1"
...
class TestEdgeTypes:
    ...
    def test_weighted_edges(self, mixed_type_graph):
        ...
        assert graph.internal_edges[edge1.ln_id].weight == 7.5
    ...
    def test_labeled_edges(self, mixed_type_graph):
        ...
        assert "new_label" in graph.internal_edges[edge2.ln_id].labels
...
class TestComplexTypes:
    ...
    def test_nested_type_node(self):
        ...
        retrieved_node = graph.internal_nodes[node.ln_id]
    ...
    def test_composite_edge(self):
        ...
        retrieved_edge = graph.internal_edges[edge.ln_id]
