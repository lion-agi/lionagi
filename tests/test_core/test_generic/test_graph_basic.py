...
from .test_graph_base import TestNode, create_test_node
...
class TestGraphProperties:
    ...
    def test_single_node_graph(self):
        ...
        assert node.ln_id in graph.node_edge_mapping
    ...
    def test_self_loop(self):
        ...
        assert edge.ln_id in graph.node_edge_mapping[node.ln_id]["in"]
        assert edge.ln_id in graph.node_edge_mapping[node.ln_id]["out"]
