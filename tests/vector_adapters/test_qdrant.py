...
from lionagi.service.adapters.vector_adapters.qdrant_vector_adapter import QdrantVectorAdapter
...
def test_documents():
    return [
        {"id": "1", "content": "test doc 1", "metadata": {"type": "test"}, "vector": [0.1, 0.2, 0.3]},
        {"id": "2", "content": "test doc 2", "metadata": {"type": "test"}, "vector": [0.4, 0.5, 0.6]}
    ]
