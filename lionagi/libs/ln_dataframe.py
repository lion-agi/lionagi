...
def extend_dataframe(
		df1: pd.DataFrame, df2: pd.DataFrame, /, unique_col: str = "node_id",
		keep="first", **kwargs, ) -> pd.DataFrame:
	"""
...
def search_keywords(
		df: pd.DataFrame, /, keywords: str | list[str], *,
		column: str = "content", case_sensitive: bool = False,
...
def replace_keyword(
		df: pd.DataFrame, /, keyword: str, replacement: str, *, inplace=True,
		column: str = "content",
		case_sensitive: bool = False, ) -> pd.DataFrame | bool:
	"""
