...
from lionagi.core.prompt.field_validator import check_dict_field, check_action_field, check_number_field, check_bool_field, check_str_field, check_enum_field, _fix_action_field, _fix_number_field, _fix_bool_field, _fix_str_field, _fix_enum_field
...
class TestValidationFunctions(unittest.TestCase):
    ...
    def test_check_dict_field_invalid_not_fixable(self):
        ...
        self.assertEqual(str(cm.exception), "Default value for DICT must be a dict, got str")
    ...
    def test_check_action_field_invalid_fixable(self):
        ...
        self.assertEqual(result, [{"function": "func1", "arguments": {}}, {"function": "func2", "arguments": {}}])
    ...
    def test_check_number_field_invalid_not_fixable(self):
        ...
        self.assertEqual(str(cm.exception), "Failed to convert not_a_number into a numeric value")

    def test_check_number_field_invalid_fix_disabled(self):
        x = "42"
        with self.assertRaises(ValueError) as cm:
            check_number_field(x, fix_=False)
        self.assertEqual(str(cm.exception), "Default value for NUMERIC must be an int or float, got str")
    ...
    def test_check_bool_field_invalid_not_fixable(self):
        ...
        self.assertEqual(str(cm.exception), "Failed to convert not_a_boolean into a boolean value")

    def test_check_bool_field_invalid_fix_disabled(self):
        x = "true"
        with self.assertRaises(ValueError) as cm:
            check_bool_field(x, fix_=False)
        self.assertEqual(str(cm.exception), "Default value for BOOLEAN must be a bool, got str")
    ...
    def test_check_str_field_invalid_not_fixable(self):
        ...
        try:
            ...
            self.assertEqual(str(e), "Default value for STRING must be a str, got object")
            
    def test_check_str_field_invalid_fix_disabled(self):
        x = 42
        with self.assertRaises(ValueError) as cm:
            check_str_field(x, fix_=False)
        self.assertEqual(str(cm.exception), "Default value for STRING must be a str, got int")
    ...
    def test_check_enum_field_invalid_not_fixable(self):
        ...
        self.assertEqual(str(cm.exception), "Default value for ENUM must be one of the ['option1', 'option2'], got option3")
    ...
    def test_check_enum_field_invalid_choices(self):
        ...
        self.assertEqual(str(cm.exception), "Field type ENUM requires all choices to be of the same type, got ['option1', 42]")
    ...
    def test_check_enum_field_invalid_type(self):
        ...
        with self.assertRaises(ValueError) as cm:
            check_enum_field(x, choices)
        self.assertEqual(str(cm.exception), "Default value for ENUM must be an instance of the str, got int")
    ...
    def test_fix_str_field_invalid(self):
        ...
        try:
            ...
            self.assertEqual(str(e), "Failed to convert <object object at 0x{:x}> into a string value".format(id(x)))
        

    def test_fix_enum_field_valid(self):
        x = "option3"
        choices = ["option1", "option2"]
        with patch("lionagi.libs.StringMatch.choose_most_similar", return_value="option1"):
    ...
    def test_fix_enum_field_invalid(self):
        x = "option3"
        choices = ["option1", "option2"]
        with patch("lionagi.libs.StringMatch.choose_most_similar", side_effect=ValueError("No match found")):
            with self.assertRaises(ValueError) as cm:
                _fix_enum_field(x, choices)
        self.assertEqual(str(cm.exception), "Failed to convert option3 into one of the choices")
    ...
    def test_fix_enum_field_valid(self):
        x = "option3"
        choices = ["option1", "option2"]
        with patch("field_validator.StringMatch.choose_most_similar", return_value="option1"):
            result = _fix_enum_field(x, choices)
        self.assertEqual(result, "option1")
    ...
    def test_fix_enum_field_invalid(self):
        x = "option3"
        choices = ["option1", "option2"]
        with patch("field_validator.StringMatch.choose_most_similar", side_effect=ValueError("No match found")):
            with self.assertRaises(ValueError) as cm:
                _fix_enum_field(x, choices)
        self.assertEqual(str(cm.exception), "Failed to convert option3 into one of the choices")
