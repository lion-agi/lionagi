...
from lionagi.core.structure.base_structure import *
...
class TestBaseStructure(unittest.TestCase):
    ...
    def test_node_edges_property(self):
        ...
        expected_result = {"node1": {"in": {"edge1": self.edge1}, "out": {"edge2": self.edge2}}}
    ...
    def test_get_node_edges_with_node(self):
        ...
        self.structure.structure_nodes = {"node1": self.node1}
        self.assertEqual(self.structure.get_node_edges(self.node1, direction="out"), [self.edge1])
        self.assertEqual(self.structure.get_node_edges(self.node1, direction="in"), [self.edge2])
        self.assertEqual(self.structure.get_node_edges(self.node1, direction="all"), [self.edge2, self.edge1])
    ...
    def test_add_structure_node_with_list(self):
        ...
        self.assertEqual(self.structure.structure_nodes, {"node1": self.node1, "node2": self.node2})
    ...
    def test_get_structure_node_with_list(self):
        self.structure.structure_nodes = {"node1": self.node1, "node2": self.node2}
        self.assertEqual(self.structure.get_structure_node(["node1", "node2"]), [self.node1, self.node2])
    ...
    def test_pop_structure_node_with_list(self):
        self.structure.structure_nodes = {"node1": self.node1, "node2": self.node2}
        self.assertEqual(self.structure.pop_structure_node(["node1", "node2"]), [self.node1, self.node2])
        self.assertEqual(self.structure.structure_nodes, {})
