...
DEFAULT_TEXT_QA_PROMPT = (
    "Provide a detailed answer to the following question based on the given context."
)
...
DEFAULT_TREE_SUMMARIZE_PROMPT = (
    "Summarize the key points and themes from the provided hierarchical information."
)
...
DEFAULT_REFINE_TABLE_CONTEXT_PROMPT = (
    "Refine the content within the table context to ensure accuracy and clarity."
)
