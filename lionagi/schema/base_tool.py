...
def generate_schema_from_function_with_docstrings(func):
    """
...
class Tool(BaseNode):
    ...
    @classmethod
    def _func_to_tool(cls, func_, parser=None):
        schema = generate_schema_from_function_with_docstrings(func_)
        tool1 = cls(
            content=schema, 
            func=func_, 
            parser=parser)
