...
def get_llama_index_node_parser(node_parser: str | NodeParser):
    if not isinstance(node_parser, [str, NodeParser]):
        raise TypeError(
...
def llama_index_parse_node(documents, node_parser: str | NodeParser,
