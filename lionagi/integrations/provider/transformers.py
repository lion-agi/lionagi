...
allowed_kwargs = ["model", "tokenizer", "modelcard", "framework", "task",
	"num_workers", "batch_size", "args_parser", "device", "torch_dtype",
	"min_length_for_response", "minimum_tokens", ]
...
class TransformersService(BaseService):
	def __init__(
			self, task: str = None, model: Union[str, Any] = None,
	...
	async def serve_chat(self, messages, **kwargs):
		...
		completion = {
			"model": self.pipe.model, "choices": [{"message": msgs}]
		}
