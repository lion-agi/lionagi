...
class BaseSession:
    ...
    def get_branch(
        self, branch: str | Branch | None = None, get_name: bool = False
    ...
    def collect(
        self, sender: str | Branch | list[str] | list[Branch] | None = None
    ) -> None:
    ...
    def send(
        self, recipient: str | Branch | list[str] | list[Branch] | None = None
    ) -> None:
