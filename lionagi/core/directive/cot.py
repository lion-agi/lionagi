...
class ChainOfThoughts(Chat):
    ...
    async def chain_of_react(
        ...
        **kwargs,
        ...
        setattr(out_, "chain_output", to_list(outs))
        setattr(out_, "chain_reason", to_list(reasons))
        setattr(out_, "chain_actions", to_list(actions))
        setattr(out_, "chain_action_response", to_list(action_responses))
