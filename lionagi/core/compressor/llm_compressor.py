...
class LLMCompressor(TokenCompressor):
    ...
    def __init__(
        ...
        self.system_msg = (
            system_msg
            or "You are tasked with compressing the following text for remembering in your memory"
        )
    ...
    async def calculate_perplexity_segment_wise(
        self, text, initial_text=None, cumulative=False, **kwargs
    ):
        ...
        segment_perplexities = await alcall(
            _segments, self.calculate_perplexity_token_wise, **kwargs
        )
        return {
            segment: perplexity
    ...
    async def compress(
        ...
        **kwargs,
        ...
        segment_perplexity = await self.calculate_perplexity_segment_wise(
            text, cumulative, initial_text=initial_text, **kwargs
        )
    ...
    async def _calculate_perpelxity_token_wise(self, tokens, **kwargs):
        ...
        for i in range(len(tokens)):
            ...
            task = asyncio.create_task(
                self.imodel.call_chat_completion(
