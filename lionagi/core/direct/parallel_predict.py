...
async def parallel_predict(sentence, *, num_sentences=1, default_key="answer", confidence_score=False, reason=False, retry_kwargs=None, **kwargs):
	if retry_kwargs is None:
		retry_kwargs = {}
	return await _force_parallel_predict(
		sentence, num_sentences, default_key, confidence_score, reason,
		retry_kwargs, **kwargs, )
