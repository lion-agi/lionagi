...
from ._component_registry import ComponentAdapterRegistry
...
class Component(CoreComponent):
    ...
    def _dispatch_from_obj(
        ...
        **kwargs: Any,
        ...
        try:
            type_ = str(type(obj)).strip("_").strip(".").strip().lower()

            if "langchain" in type_:
                return cls.adapt_from(obj, "langchain_doc", **kwargs)

            if "llama_index" in type_:
                return cls.adapt_from(obj, "llamaindex_node", **kwargs)
