...
class ExpertForm(Form):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            name=_config.pop("name", None),
            thinking_style=_config.pop("thinking_style", None),
            guidance=_config.pop("guidance", None),
            instruction=_config.pop("instruction", None),
            context=_config.pop("context", None),
            assignment=_config.pop("assignment", None),
            **_config,
        )
